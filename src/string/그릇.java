...
//    만일 그릇이 서로 반대방향으로 쌓이면 높이는 그릇만큼,
//    즉 10cm 늘어난다. 그릇을 괄호 기호로 나타내어 설명해보자.
...
//    왜냐하면 처음 바닥에 있는 그릇의 높이가 10cm이고 이후
//    같은 방향으로 3개의 그릇이 포개져 있으므로 늘어난 높이는 5+5+5=15 이기 때문이다.
...
//
//    출력
//    여러분은 그릇 방향이 괄호 문자로 표시된 문자열을 읽어서
//    그 최종의 높이를 정수로 출력해야 한다.
...
public class 그릇 {
    public static void main(String[] args) throws IOException {
        ...
        char[] dishes = in.readLine().toCharArray();
        int height = 0;
        if(dishes.length > 0)
            height = 10;
