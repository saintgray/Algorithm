...
//    그림 1 : https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/upload/images2/elevator.png
...
public class ACM호텔 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < testCase; i++) {
            ...
            // 방번호 :
            int roomNo = reservationNo % H > 0 ? (reservationNo / H) + 1 : (reservationNo / H);
            int floorNo = reservationNo % H == 0 ? H : reservationNo % H;
            System.out.println(String.join("",
                    String.valueOf(floorNo), roomNo / 10 == 0 ? "0".concat(String.valueOf(roomNo)) : String.valueOf(roomNo)));
        }
    }
}
